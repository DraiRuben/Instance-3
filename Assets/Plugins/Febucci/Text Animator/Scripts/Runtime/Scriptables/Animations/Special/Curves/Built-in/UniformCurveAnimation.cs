...
namespace Febucci.UI.Effects
{
    ...
    public sealed class UniformCurveAnimation : AnimationScriptableBase
    {
        ...
        public override void ApplyEffectTo(ref Core.CharacterData character, TAnimCore animator)
        {
            ...
            if (animationData.TryCalculatingMatrix(character, timePassed, weight, out Matrix4x4 matrix, out Vector3 offset))
            {
            ...
            if (animationData.TryCalculatingColor(character, timePassed, weight, out Color32 color))
            {
