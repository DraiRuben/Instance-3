...
namespace Febucci.UI.Examples
{
    ...
    public class DefaultEffectsExample : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            foreach (AnimationScriptableBase effect in typewriter.TextAnimator.DatabaseBehaviors.Data)
            {
                if (!effect) continue;
            ...
            foreach (AnimationScriptableBase effect in typewriter.TextAnimator.DatabaseAppearances.Data)
            {
                if (!effect) continue;
