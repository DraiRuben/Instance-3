...
namespace Shapes
{
    ...
    public static partial class Draw
    {
        ...
        [OvldGenCallTarget]
        static void Line_Internal([OvldDefault(nameof(LineEndCaps))] LineEndCap endCaps,
        ...
        [OvldGenCallTarget]
        static void Polyline_Internal(PolylinePath path,
        ...
        [OvldGenCallTarget]
        static void Polygon_Internal(PolygonPath path,
        ...
        [OvldGenCallTarget]
        static void RegularPolygon_Internal([OvldDefault(nameof(RegularPolygonSideCount))] int sideCount,
        ...
        [OvldGenCallTarget]
        static void Rectangle_Internal([OvldDefault(nameof(BlendMode))] ShapesBlendMode blendMode,
        ...
        [OvldGenCallTarget]
        static void Triangle_Internal(Vector3 a,
                                                           Vector3 b,
                                                           Vector3 c,
                                                           bool hollow,
                                                           [OvldDefault(nameof(Thickness))] float thickness,
        ...
        [OvldGenCallTarget]
        static void Quad_Internal(Vector3 a,
                                                       Vector3 b,
                                                       Vector3 c,
        ...
        [OvldGenCallTarget]
        static void Sphere_Internal([OvldDefault(nameof(Radius))] float radius,
                                                         [OvldDefault(nameof(Color))] Color color)
        {
        ...
        [OvldGenCallTarget]
        static void Cone_Internal(float radius,
                                                       float length,
        ...
        [OvldGenCallTarget]
        static void Cuboid_Internal(Vector3 size,
                                                         [OvldDefault(nameof(Color))] Color color)
        {
        ...
        [OvldGenCallTarget]
        static void Torus_Internal(float radius,
                                                        float thickness,
        ...
        [OvldGenCallTarget]
        static void TextRect_Internal(string content,
        ...
        [OvldGenCallTarget]
        static void Text_Internal(bool isRect,
                                                       string content,
                                                       [OvldDefault("null")] TextElement element,
        ...
        [OvldGenCallTarget]
        static void Texture_Internal(Texture texture, Rect rect, Rect uvs, [OvldDefault(nameof(Color))] Color color)
        {
            if (texture == null)
        ...
        [MethodImpl(INLINE)]
        static void Texture_Placement_Internal(
            Texture texture,
        ...
        [MethodImpl(INLINE)]
        [OvldGenCallTarget]
        static void Texture_RectFill_Internal(
            Texture texture,
            Rect rect,
        ...
        [MethodImpl(INLINE)]
        [OvldGenCallTarget]
        static void Texture_PosSize_Internal(
            Texture texture,
            Vector2 center,
            float size,
